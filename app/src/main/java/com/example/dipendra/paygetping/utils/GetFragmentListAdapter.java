...
public class GetFragmentListAdapter extends ArrayAdapter<Transaction>{

    private Context context;
    private int resource;
    private ArrayList<Transaction> objects;
    public GetFragmentListAdapter(Context context, int resource, ArrayList<Transaction> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        name.setText(objects.get(position).getTo().getName());
        id.setText(objects.get(position).getTo().getEncodedEmail().replace(",","."));
